...
export default function Nav() {
    ...
    return (
        <nav className="w-screen fixed top-0 left-0 right-0 z-1000 bg-[#004AF7] p-5 shadow-lg/30">
            <div className="max-w-[1440px] mx-auto flex justify-between items-center text-white font-bold font-[Raleway] *:transition-all *:duration-300" >
                <a href={'/'}><Image src={'/logo-nav.svg'} alt="logo inception" width={154} height={140} ></Image></a>
                <div className="space-x-4 *:hover:scale-105 mr-20">
                    {navitems.map((each, i) => {
                        return (
